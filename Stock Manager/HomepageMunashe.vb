...
Public Class HomepageMunashe

    Private ID As String = ""
    Private Sub HomepageMunashe_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ResetMe()
        LoadData()
    End Sub
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        SQL = "INSERT INTO MUNASHE(Product, Quantity, BuyPrice, SellPrice) VALUES(@Product, @Quantity, @BuyPrice, @SellPrice)"
        Execute(SQL, "Insert")
    ...
    Private Sub LoadData(Optional keyword As String = "")
        ...
        SQL = "SELECT * FROM MUNASHE ORDER BY ID ASC"
        ...
        Dim sumSQL As String = "SELECT SUM(Quantity) AS QuantityTotal, SUM(TotalCost) AS TotalCost, SUM(TotalReturns) AS TotalReturns, SUM(TotalReturns)-SUM(TotalCost) AS TotalProfits  FROM MUNASHE"
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        SQL = "UPDATE MUNASHE SET Product = @Product, Quantity = @Quantity , BuyPrice = @BuyPrice, SellPrice = @SellPrice WHERE ID = @ID"
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        If MessageBox.Show("Do you want to delete the selected product permanentl?",
            ...
            SQL = "DELETE * FROM MUNASHE WHERE ID = @ID"

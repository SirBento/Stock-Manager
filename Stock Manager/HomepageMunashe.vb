...
Public Class HomepageMunashe
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        SQL = "INSERT INTO MUNASHE(Product, Quantity, UnitPrice) VALUES(@Product, @Quantity, @UnitPrice)"
        Execute(SQL, "Insert")
    ...
    Private Sub LoadData(Optional keyword As String = "")
        ...
        Dim sumSQL As String = "SELECT SUM(Quantity) AS QuantityTotal, SUM(TotalPrice) AS TotalProfits  FROM MUNASHE"
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        SQL = "UPDATE MUNASHE SET Product = @Product, Quantity = @Quantity , UnitPrice = @UnitPrice WHERE ID = @ID"
